use super::{Buffer, F, diff_factor_f32};

pub fn bilateral_filter_f32<const C: usize, const C_PLUS_1: usize>(
    img_src: &[f32],
    img_dst: &mut [f32],
    w: usize,
    h: usize,
    ...
    // left pass
    {
        for y in 0..h {
            ...
            for x in 1..w {
                ...
                let diff = diff_factor_f32(src_curr, src_prev);
    ...
    let sch = lp;
    {
        ...
        for y in 0..h - 1 {
            for x in 0..w {
                ...
                let diff = diff_factor_f32(src_color_curr, src_color_prev);
